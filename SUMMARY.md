...
* [Installation System](page/be-installation-system.md)
* [Update BE to the newest version](page/update-be-to-the-newest-version.md)
...
* [Create a Home page](page/create-a-home-page.md)
* [Banner Slider block](page/banner-slider-block.md)
* [Product list block](page/product-list-block.md)
* [Promotion block](page/promotion-block.md)
* [Contact block](page/contact-block.md)

## Product manager

* [Product Manager](page/product-manager.md)
* [Product's Category](page/products-category.md)
* [Create a new Product](page/create-a-new-product.md)
...
* [Coupon Manager](page/coupon-manager.md)
* [Adding a coupon](page/adding-a-coupon.md)

## Sales Campaigns

* [Sale Campaigns](page/sale-campaigns.md)

## Reports manager

* [Review Manager](page/be-review-manager.md)
...
* [Email settings](page/be-email-settings.md)
* [Store Settings](page/store-settings.md)
* [Product settings](page/product-settings.md)
* [Tax Settings](page/tax-settings.md)
* [Orders settings](page/orders-settings.md)
* [Shipping Settings](page/shipping-settings.md)
* [Currency settings](page/currency-settings.md)
* [Vendor settings](page/be-vendor-settings.md)
* [User Settings](page/be-user-settings.md)
* [Google reCaptcha](page/google-recaptcha.md)
* [Map Provider](page/map-provider-1.md)
* [Cookie agreement](page/cookie-agreement.md)
* [Custom Scripts](page/custom-scripts.md)
